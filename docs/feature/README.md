...
| 学習画面 | [`learning.md`](learning.md) | 言語アイコンと難易度範囲スライダーから学習カテゴリー・学習項目を選び、タスク設定に対応した問題を含む四択問題へ継続的に回答し、正誤・解説に加えて5問ごとの正解数・獲得XPを確認しながら学習する。 | `lib/features/learn/presentation/`、`lib/shared/widgets/programming_language_icon.dart`、`lib/features/learn/data/`、`lib/features/learn/domain/` |
